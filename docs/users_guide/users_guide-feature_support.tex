...
\multicolumn{2}{| l |}{\multirow[c]{6}{*}[-90pt]{Datatype}} & Atomic & Yes &
    \multirow[c]{5}{\linewidth}{Variable-length of Array datatypes and Variable-length datatypes inside Compound datatypes are currently unsupported. Datatype conversion for the parent datatype is currently unsupported.} \\ [30pt] \cline{3-4}
...
& \multirow[c]{4}{\linewidth}[-55pt]{Selection Type} & NONE & Yes & \multirow[c]{4}{\linewidth}{For chunked datasets, the selection currently must be the same shape in the memory and file dataspaces} \\ [28pt] \cline{3-4}
& & H5S\_ALL & Yes & \\ [28pt] \cline{3-4}
& & Hyperslab Selection & Yes & \\ [28pt] \cline{3-4}
& & Point Selection & Yes & \\ [28pt] \cline{3-4} \hline

\multicolumn{2}{| l |}{\multirow[c]{6}{*}[-90pt]{Datatype}} & Atomic & Yes & \multirow[c]{5}{\linewidth}{Variable-length of Array datatypes and Variable-length datatypes inside Compound datatypes are currently unsupported. Datatype conversion for the parent datatype is currently unsupported.} \\ [30pt] \cline{3-4}
\multicolumn{2}{| l |}{} & Compound & Yes & \\ [30pt] \cline{3-4}
\multicolumn{2}{| l |}{} & Variable-length & Yes & \\ [30pt] \cline{3-4}
\multicolumn{2}{| l |}{} & Array & Yes & \\ [30pt] \cline{3-4}
\multicolumn{2}{| l |}{} & Opaque & Yes & \\ [30pt] \cline{3-4}
...
& \multirow[c]{8}{\linewidth}[-60pt]{Access Properties (Other)} & MPI-I/O Collective Metadata Ops & Yes & By default, all metadata operations are collective for writes and independent for reads. \\ \cline{3-5}
