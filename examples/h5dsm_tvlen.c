...
static int
check_vla(const hvl_t *vla1, const hvl_t *vla2)
{
    int i, j, k;
...
main(int argc, char *argv[])
{
    ...
    const hvl_t rbuf_vla_init[4][2] = {{{1, &bogus_int}, {1, &bogus_int}},
                                       ...
                                       {{1, &bogus_int}, {1, &bogus_int}},
                                       {{1, &bogus_int}, {1, &bogus_int}}};
    char *const rbuf_vls_init[4][2] = {
        {bogus_str, bogus_str}, {bogus_str, bogus_str}, {bogus_str, bogus_str}, {bogus_str, bogus_str}};
