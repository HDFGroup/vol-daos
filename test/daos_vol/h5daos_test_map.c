...
#define VLCMP(A, B, TYPE) \
((A).len != (B).len || memcmp((A).p, (B).p, (A).len * sizeof(TYPE)))
...
\
        ...
        for(_i = 0; _i < (A).len; _i++) \
            if(!FLOAT_EQUAL((double)((A_TYPE *)(A).p)[_i], \
                    (double)((B_TYPE *)(B).p)[_i])) { \
                RESULT = 1; \
                break; \
        } \
    } \
 ...
 */
static int
test_create_map(hid_t file_id, const char *map_name, hid_t key_dtype,
    hid_t value_dtype, hid_t mcpl_id, hid_t mapl_id, hbool_t print_msg)
{
    hid_t map_id = -1;
    hid_t id_out = -1;
    hid_t copied_mcpl = -1;
 ...
 */
static int
test_open_map(hid_t file_id, const char *map_name, hid_t key_dtype,
    hid_t value_dtype, hid_t mcpl_id, hid_t mapl_id, hbool_t print_msg)
{
    hid_t map_id = -1;
    hid_t id_out = -1;
...
test_map_set(hid_t file_id, const char *map_name, hid_t key_dtype, hid_t value_dtype, hbool_t print_msg)
{
    ...
    if(!strcmp(map_name, MAP_INT_INT_NAME) || !strncmp(map_name, "map_large_name_", strlen("map_large_name_"))) {
        ...
        /* Set the values */
        for(i = 0; i < NUMB_KEYS; i++)
            if(H5Mput(map_id, key_dtype, &enum_enum_keys[i], value_dtype, &enum_enum_vals[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to set key-value pair\n");
                goto error;
            } /* end if */
        ...
        /* Set the values */
        for(i = 0; i < NUMB_KEYS; i++)
            if(H5Mput(map_id, key_dtype, &comp_comp_keys[i], value_dtype, &comp_comp_vals[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to set key-value pair\n");
                goto error;
            } /* end if */
        ...
        /* Set the values */
        for(i = 0; i < NUMB_KEYS; i++)
            if(H5Mput(map_id, key_dtype, &nested_comp_keys[i], value_dtype, &nested_comp_vals[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to set key-value pair\n");
                goto error;
            } /* end if */
        ...
        /* Set the values */
        for(i = 0; i < NUMB_KEYS; i++)
            if(H5Mput(map_id, key_dtype, &stconv_int_keys[i], value_dtype, &stconv_int_vals[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to set key-value pair\n");
                goto error;
            } /* end if */
        ...
        /* Set the values */
        for(i = 0; i < NUMB_KEYS; i++)
            if(H5Mput(map_id, key_dtype, &stconv_long_long_keys[i], value_dtype, &stconv_double_vals[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to set key-value pair\n");
                goto error;
            } /* end if */
        ...
        /* Set the values */
        for(i = 0; i < NUMB_KEYS; i++)
            if(H5Mput(map_id, key_dtype, &vl_long_long_keys[i], value_dtype, &vl_double_vals[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to set key-value pair\n");
                goto error;
            } /* end if */
        ...
        for(i = 0; i < LARGE_NUMB_KEYS; i++)
            if(H5Mput(map_id, key_dtype, &large_int_int_keys[i], value_dtype, &large_int_int_vals[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to set key-value pair\n");
                goto error;
            } /* end if */
...
test_map_get(hid_t file_id, const char *map_name, hid_t key_dtype, hid_t value_dtype, hbool_t print_msg)
{
    ...
    if(!strcmp(map_name, MAP_INT_INT_NAME) || !strncmp(map_name, "map_large_name_", strlen("map_large_name_"))) {
        ...
        for(i = 0; i < NUMB_KEYS; i++) {
            if(H5Mget(map_id, key_dtype, &nested_comp_keys[i], value_dtype, &nested_comp_out[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to get key-value pair\n");
                goto error;
            } /* end if */
        ...
        for(i = 0; i < NUMB_KEYS; i++) {
            if(H5Mget(map_id, H5T_NATIVE_INT, &stconv_int_keys[i], H5T_NATIVE_INT, &stconv_int_vals_out[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to get key-value pair\n");
                goto error;
            } /* end if */
            ...
            if(H5Mget(map_id, H5T_NATIVE_LLONG, &tmp_ll, H5T_NATIVE_DOUBLE, &stconv_double_vals_out[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to get key-value pair\n");
                goto error;
            } /* end if */
        ...
        for(i = 0; i < NUMB_KEYS; i++) {
            if(H5Mget(map_id, H5T_NATIVE_LLONG, &stconv_long_long_keys[i], H5T_NATIVE_DOUBLE, &stconv_double_vals_out[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to get key-value pair\n");
                goto error;
            } /* end if */
            ...
            if(H5Mget(map_id, H5T_NATIVE_INT, &tmp_int, H5T_NATIVE_INT, &stconv_int_vals_out[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to get key-value pair\n");
                goto error;
            } /* end if */
        ...
        for(i = 0; i < NUMB_KEYS; i++) {
            if(H5Mget(map_id, vl_int_dtype_id, &vl_int_keys[i], vl_int_dtype_id, &vl_int_vals_out[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to get key-value pair\n");
                goto error;
            } /* end if */
...
test_map_update(hid_t file_id, const char *map_name, hid_t key_dtype, hid_t value_dtype)
{
    ...
    if(!strcmp(map_name, MAP_INT_INT_NAME)) {
        ...
        for(i = 0; i < NUMB_KEYS; i++) {
            ...
            if(H5Mput(map_id, key_dtype, &int_int_keys[i], value_dtype, &updated_values[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to set key-value pair\n");
                goto error;
            } /* end if */
        ...
        for(i = 0; i < NUMB_KEYS; i++) {
            ...
            if(H5Mput(map_id, key_dtype, &enum_enum_keys[i], value_dtype, &updated_values[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to set key-value pair\n");
                goto error;
            } /* end if */
        ...
        for(i = 0; i < NUMB_KEYS; i++) {
            if(H5Mput(map_id, key_dtype, &vls_vls_keys[i], value_dtype, &updated_values[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to set key-value pair\n");
                goto error;
            } /* end if */
        ...
        for(i = 0; i < NUMB_KEYS; i++) {
            ...
            if(H5Mput(map_id, key_dtype, &comp_comp_keys[i], value_dtype, &updated_values[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to set key-value pair\n");
                goto error;
            } /* end if */
        ...
        for(i = 0; i < NUMB_KEYS; i++) {
            ...
            if(H5Mput(map_id, key_dtype, &nested_comp_keys[i], value_dtype, &updated_values[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to set key-value pair\n");
                goto error;
            } /* end if */
        ...
        for(i = 0; i < NUMB_KEYS; i++) {
            ...
            if(H5Mput(map_id, key_dtype, &stconv_int_keys[i], value_dtype, &updated_values[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to set key-value pair\n");
                goto error;
            } /* end if */

            if(H5Mget(map_id, key_dtype, &stconv_int_keys[i], value_dtype, &stconv_int_vals_out[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to get key-value pair\n");
                goto error;
            } /* end if */
        ...
        for(i = 0; i < NUMB_KEYS; i++) {
            ...
            if(H5Mput(map_id, key_dtype, &stconv_long_long_keys[i], value_dtype, &updated_values[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to set key-value pair\n");
                goto error;
            } /* end if */

            if(H5Mget(map_id, key_dtype, &stconv_long_long_keys[i], value_dtype, &stconv_double_vals_out[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to get key-value pair\n");
                goto error;
            } /* end if */
        ...
        for(i = 0; i < NUMB_KEYS; i++) {
            ...
            if(H5Mget(map_id, key_dtype, &vl_int_keys[i], value_dtype, &vl_int_vals_out[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to get key-value pair\n");
                goto error;
            } /* end if */
        ...
        for(i = 0; i < NUMB_KEYS; i++) {
            ...
            if(H5Mput(map_id, key_dtype, &vl_long_long_keys[i], value_dtype, &updated_value, H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to set key-value pair\n");
                goto error;
            } /* end if */

            if(H5Mget(map_id, key_dtype, &vl_long_long_keys[i], value_dtype, &vl_double_vals_out[i], H5P_DEFAULT) < 0) {
                H5_FAILED(); AT();
                printf("failed to get key-value pair\n");
                goto error;
            } /* end if */
...
map_iterate_cb(hid_t map_id, const void *_key, void *_iterate_ud)
{
    ...
    if(!strcmp(iterate_ud->map_name, MAP_INT_INT_NAME)) {
        ...
        for(i = 0; i < NUMB_KEYS; i++) {
            if(nested_comp_keys[i].a == ((const compound_t *)_key)->a && nested_comp_keys[i].b == ((const compound_t *)_key)->b) {
                iterate_ud->keys_visited[i]++;
                break;
            } /* end if */
        }
...
map_iterate_cb2(hid_t map_id, const void *_key, void *_iterate_ud)
{
    ...
    if(!strcmp(iterate_ud->map_name, MAP_INT_INT_NAME)) {
        ...
        if(nested_comp_keys[0].a == ((const compound_t *)_key)->a && nested_comp_keys[0].b == ((const compound_t *)_key)->b) {
            H5_FAILED(); AT();
            printf("deleted key still exists\n");
            goto error;
        } /* end if */
 ...
 */
static int
test_map_get_count(hid_t file_id, const char *map_name, hsize_t expected_count,
    hbool_t print_msg)
{
    hid_t map_id = -1;
    hsize_t count;
...
test_integer(hid_t file_id)
{
    ...
    if((mcpl_id = H5Pcreate(H5P_MAP_CREATE)) < 0) goto error;
    if((mapl_id = H5Pcreate(H5P_MAP_ACCESS)) < 0) goto error;

    nerrors += test_create_map(file_id, MAP_INT_INT_NAME, H5T_NATIVE_INT, H5T_NATIVE_INT, mcpl_id, mapl_id, TRUE);
    nerrors += test_open_map(file_id, MAP_INT_INT_NAME, H5T_NATIVE_INT, H5T_NATIVE_INT, mcpl_id, mapl_id, TRUE);
    ...
    if(H5Pclose(mcpl_id) < 0) goto error;
    if(H5Pclose(mapl_id) < 0) goto error;
...
test_enum(hid_t file_id)
{
    ...
    nerrors += test_create_map(file_id, MAP_ENUM_ENUM_NAME, key_dtype_id, value_dtype_id, mcpl_id, mapl_id, TRUE);
    nerrors += test_open_map(file_id, MAP_ENUM_ENUM_NAME, key_dtype_id, value_dtype_id, mcpl_id, mapl_id, TRUE);
...
test_nested_compound(hid_t file_id)
{
    ...
    TESTING("nested compound as the datatype of keys and values"); HDputs("");
...
test_simple_tconv(hid_t file_id)
{
    ...
    TESTING("simple type conversion"); HDputs("");
    ...
    nerrors += test_create_map(file_id, MAP_SIMPLE_TCONV1_NAME, H5T_NATIVE_LLONG, H5T_NATIVE_DOUBLE, mcpl_id, mapl_id, TRUE);
    nerrors += test_open_map(file_id, MAP_SIMPLE_TCONV1_NAME, H5T_NATIVE_LLONG, H5T_NATIVE_DOUBLE, mcpl_id, mapl_id, TRUE);
    ...
    nerrors += test_create_map(file_id, MAP_SIMPLE_TCONV2_NAME, H5T_NATIVE_INT, H5T_NATIVE_INT, mcpl_id, mapl_id, TRUE);
    nerrors += test_open_map(file_id, MAP_SIMPLE_TCONV2_NAME, H5T_NATIVE_INT, H5T_NATIVE_INT, mcpl_id, mapl_id, TRUE);
...
test_vl_tconv(hid_t file_id)
{
    ...
    TESTING("type conversion of variable-length parent type"); HDputs("");
    ...
    nerrors += test_create_map(file_id, MAP_VL_TCONV1_NAME, vl_long_long_dtype_id, vl_double_dtype_id, mcpl_id, mapl_id, TRUE);
    nerrors += test_open_map(file_id, MAP_VL_TCONV1_NAME, vl_long_long_dtype_id, vl_double_dtype_id, mcpl_id, mapl_id, TRUE);
    ...
    nerrors += test_create_map(file_id, MAP_VL_TCONV2_NAME, vl_int_dtype_id, vl_int_dtype_id, mcpl_id, mapl_id, TRUE);
    nerrors += test_open_map(file_id, MAP_VL_TCONV2_NAME, vl_int_dtype_id, vl_int_dtype_id, mcpl_id, mapl_id, TRUE);
    ...
    nerrors += test_map_nonexistent_key(file_id, MAP_VL_TCONV2_NAME, vl_long_long_dtype_id, vl_double_dtype_id);
...
test_many_entries(hid_t file_id)
{
    ...
    nerrors += test_create_map(file_id, MAP_MANY_ENTRIES_NAME, H5T_NATIVE_INT, H5T_NATIVE_INT, mcpl_id, mapl_id, TRUE);
    nerrors += test_open_map(file_id, MAP_MANY_ENTRIES_NAME, H5T_NATIVE_INT, H5T_NATIVE_INT, mcpl_id, mapl_id, TRUE);
...
test_many_maps(hid_t file_id)
{
    ...
    for(i = 0; i < LARGE_NUMB_MAPS; i++) {
        ...
        nerrors += test_create_map(file_id, map_name, H5T_NATIVE_INT, H5T_NATIVE_INT, mcpl_id, mapl_id, FALSE);
