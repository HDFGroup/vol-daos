...
find_library(DAOS_UNIFIED_NAMESPACE_LIBRARY NAMES duns
  HINTS ${PC_DAOS_LIBDIR} ${PC_DAOS_LIBRARY_DIRS}
  PATHS /usr/local/lib64 /usr/local/lib /usr/lib64 /usr/lib)

set(DAOS_INCLUDE_DIRS ${DAOS_INCLUDE_DIR})
set(DAOS_LIBRARIES ${DAOS_LIBRARY} ${DAOS_COMMON_LIBRARY} ${DAOS_UNIFIED_NAMESPACE_LIBRARY})
...
find_package_handle_standard_args(DAOS DEFAULT_MSG
                                  DAOS_INCLUDE_DIR DAOS_LIBRARY DAOS_COMMON_LIBRARY DAOS_UNIFIED_NAMESPACE_LIBRARY)

mark_as_advanced(DAOS_INCLUDE_DIR DAOS_LIBRARY DAOS_COMMON_LIBRARY DAOS_UNIFIED_NAMESPACE_LIBRARY)
