...
herr_t
iter_cb(hid_t loc_id, const char *link_name, const H5L_info2_t *linfo, void *op_data)
{
    (void)loc_id;
...
main(int argc, char *argv[])
{
    ...
    /* Iterate */
    if ((ret = H5Literate_by_name2(file, argv[3], H5_INDEX_NAME, H5_ITER_NATIVE, &num_link, iter_cb,
