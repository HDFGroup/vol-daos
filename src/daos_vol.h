...
/* Other link routines */
H5VL_DAOS_PRIVATE int H5_daos_link_write(H5_daos_group_t *grp, const char *name,
...
H5VL_DAOS_PRIVATE herr_t H5_daos_link_iterate(H5_daos_group_t *target_grp, H5_daos_iter_data_t *link_iter_data,
    tse_task_t **first_task, tse_task_t **dep_task);
H5VL_DAOS_PRIVATE herr_t H5_daos_link_get_name_by_idx(
...
H5VL_DAOS_PRIVATE herr_t H5_daos_dataset_get(void *_dset, H5VL_dataset_get_args_t *get_args,
    hid_t dxpl_id, void **req);
...
H5VL_DAOS_PRIVATE void *H5_daos_dataset_create_helper(H5_daos_file_t *file, hid_t type_id,
    hid_t space_id, hid_t dcpl_id, hid_t dapl_id, H5_daos_group_t *parent_grp, const char *name,
    size_t name_len, hbool_t collective, H5_daos_req_t *req, tse_task_t **first_task, tse_task_t **dep_task);
...
H5VL_DAOS_PRIVATE herr_t H5_daos_dataset_write_int(H5_daos_dset_t *dset,
    hid_t mem_type_id, hid_t mem_space_id, hid_t file_space_id,
    htri_t need_tconv, const void *buf, tse_task_t *_end_task,
    H5_daos_req_t *req, tse_task_t **first_task, tse_task_t **dep_task);
...
H5VL_DAOS_PRIVATE herr_t H5_daos_datatype_get(void *_dtype, H5VL_datatype_get_args_t *get_args,
    hid_t dxpl_id, void **req);
...
H5VL_DAOS_PRIVATE void *H5_daos_datatype_commit_helper(H5_daos_file_t *file, hid_t type_id,
...
H5VL_DAOS_PRIVATE herr_t H5_daos_attribute_write(void *_attr, hid_t mem_type_id, const void *buf,
    hid_t dxpl_id, void **req);
H5VL_DAOS_PRIVATE herr_t H5_daos_attribute_get(void *_item, H5VL_attr_get_args_t *get_args,
    hid_t dxpl_id, void **req);
H5VL_DAOS_PRIVATE herr_t H5_daos_attribute_specific(void *_item,
    const H5VL_loc_params_t *loc_params, H5VL_attr_specific_args_t *specific_args,
    hid_t dxpl_id, void **req);
...
H5VL_DAOS_PRIVATE void *H5_daos_attribute_create_helper(H5_daos_item_t *item,
    const H5VL_loc_params_t *loc_params, hid_t type_id, hid_t space_id, hid_t acpl_id,
    hid_t aapl_id, const char *attr_name, hbool_t collective, H5_daos_req_t *req,
    tse_task_t **first_task, tse_task_t **dep_task);
...
H5VL_DAOS_PRIVATE herr_t H5_daos_map_put(void *_map, hid_t key_mem_type_id,
    ...
    void **req);
H5VL_DAOS_PRIVATE herr_t H5_daos_map_get(void *_map, H5VL_map_args_t *map_args,
    hid_t dxpl_id, void **req);
H5VL_DAOS_PRIVATE herr_t H5_daos_map_specific(void *_item, H5VL_map_args_t *map_args,
    hid_t dxpl_id, void **req);
#ifdef DV_HAVE_MAP
...
H5VL_DAOS_PRIVATE herr_t H5_daos_map_flush(H5_daos_map_t *map,
    H5_daos_req_t *req, tse_task_t **first_task, tse_task_t **dep_task);
...
H5VL_DAOS_PRIVATE herr_t H5_daos_mpi_ibcast(H5_daos_mpi_ibcast_ud_t *_bcast_udata,
    H5_daos_obj_t *obj, size_t buffer_size, hbool_t empty,
    tse_task_cb_t bcast_prep_cb, tse_task_cb_t bcast_comp_cb,
    H5_daos_req_t *req, tse_task_t **first_task, tse_task_t **dep_task);
